export const links = {
  ...
  resume:
    "https://drive.google.com/file/d/1nloIwHwxYrwPYLKjqRIckvIEJtj9Mpwk/view?usp=share_link",
  twitter: "https://twitter.com/sumrenders",
};
export const projects = [
  // {
  //   name: "Portfolio",
  //   desc: "Portfolio designed by self after stealing *ehem* borrowing design from YouTube.",
  //   img: "",
  //   stack: ["ReactJS"],
  //   link: "",
  // },
...
export const experiences = [
  {
    ...
    name: "MS Engage Mentee",
    desc: "Designed and created an eCommerce web application where the user can get recommendations based on their face features. Learned about Agile programming",
  },
  {
